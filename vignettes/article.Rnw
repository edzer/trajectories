...
\Plainauthor{M. Mehdi Moradi, Edzer Pebesma, Jorge Mateu}
...
URL: \url{ https://www.uni-muenster.de/Geoinformatics/ } \\
...
The entire dataset is stored in the \proglang{R} package  \pkg{taxidata}  and can be installed through the following code.

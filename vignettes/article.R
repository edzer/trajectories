...
###################################################
### code chunk number 5: article.Rnw:175-186
###################################################
set.seed(10)
...
###################################################
### code chunk number 6: article.Rnw:190-191
###################################################
plot(A1)


###################################################
### code chunk number 7: article.Rnw:201-207
###################################################
x <- runif(10,0,1)
y <- runif(10,0,1)
...
###################################################
### code chunk number 8: article.Rnw:213-223
###################################################
x = c(7,6,6,7,7)
y = c(6,5,4,4,3)
n = length(x)
...
###################################################
### code chunk number 9: article.Rnw:229-249
###################################################
# person B, track 1:
x = c(2,2,1,1,2,3)
y = c(5,4,3,2,2,3)
...
###################################################
### code chunk number 10: article.Rnw:298-302
###################################################
dim(A1)
dim(B1)
stbox(A1)
...
###################################################
### code chunk number 11: article.Rnw:306-307
###################################################
stplot(Tr, attr = "co2", arrows = TRUE, lwd = 3, by = "IDs")


###################################################
### code chunk number 12: article.Rnw:317-323
###################################################
set.seed(10)
x <- rTrack();x
...
###################################################
### code chunk number 13: article.Rnw:327-330
###################################################
...
###################################################
### code chunk number 14: article.Rnw:344-347
###################################################
library(forecast)
data(A3)
auto.arima.Track(A3)
...
###################################################
### code chunk number 15: article.Rnw:380-389
###################################################
library(xts)
track2 <- A3
